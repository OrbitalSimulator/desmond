...
class TestNewtonGravityFunction 
{
	...
	{	
		/*Setup*/
	    ArrayList<Vector3d> vel = new ArrayList<Vector3d>();																//Initialize arrayList of velocity vectors (First two planets)
	    ...
	    ArrayList<Vector3d> pos = new ArrayList<Vector3d>();																//Initialize arrayList of position vectors (First two planets)
	    ...
	    StateInterface test = new State(vel, pos);																			//Generate the current state 
