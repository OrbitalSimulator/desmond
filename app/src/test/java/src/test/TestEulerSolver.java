...
{
	static ArrayList<Vector3d> v = new ArrayList<Vector3d>();																			
	static ArrayList<Vector3d> p =  new ArrayList<Vector3d>();
    double[] masses = {1.988500e30, 3.302e23};																							
	StateInterface initial = new State(v,p);																								
	...
	public static void init()
	{
		...
		v.add(new Vector3d(-1.420511669610689e+01, -4.954714716629277e+00,  3.994237625449041e-01));										
		v.add(new Vector3d( 3.892585189044652e+04,  2.978342247012996e+03, -3.327964151414740e+03));										

		p.add(new Vector3d( -6.806783239281648e+08,   1.080005533878725e+09,   6.564012751690170e+06));										
		p.add(new Vector3d(  6.047855986424127e+06,  -6.801800047868888e+10,  -5.702742359714534e+09));										
	}
	
	@Test
	public void testSingleStep() 
	{
		ODEFunctionInterface funct1 = new NewtonGravityFunction(masses);																	
	    ...
	    System.out.println("Single step: "+ results1.toString());																			
	    System.out.println("\n==========================");

		assertEquals(new Vector3d(-14.205116696061488, -4.954714721197586,  0.39942376216744196), resultsConverted.velocity.get(0));		
	...
	public void testFunction2() 
	{
		...
		assertEquals(new Vector3d(-14.205116695879855, -4.954714739470827, 0.399423760657591), finalResultConverted.velocity.get(0));			
		...
		assertEquals(new Vector3d(38925.850523216846, 2978.47980129011, -3327.952785811886), finalResultConverted.velocity.get(1));				
	...
	public void testFunction3() 
	{
		...
		State intermimRes = (State)results3[3];																									
		...
		State finalRes = (State)results3[5];																									
